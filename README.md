...
- 官能基候補の収集：データベースから官能基のリストを作成し、SMILES で指定した分子骨格に修飾して候補物質を生成する（prepareCandidateA）。
- 官能基組合せの検討：複数の有効な官能基を骨格の複数箇所に修飾した場合の候補物質について吸収スペクトルを比較する（prepareCandidateB）。
